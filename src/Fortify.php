...
use Heritage\Support\Facades\Crypt;
...
use Ugarit\Fortify\Http\Responses\SimpleViewResponse;
...
class Fortify
{
     ...
     *
     * @var \Heritage\Contracts\Encryption\Encrypter|null
     */
     ...
     *
     * @param  \Heritage\Contracts\Encryption\Encrypter|null  $encrypter
     * @return static
     */
     ...
     *
     * @return \Heritage\Contracts\Encryption\Encrypter
     */
