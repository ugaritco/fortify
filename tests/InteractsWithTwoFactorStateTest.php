...
use Ugarit\Fortify\Tests\Models\UserWithTwoFactor;
use Ugarit\Fortify\Tests\Requests\FormRequestInteractsWithTwoFactorState;
...
class InteractsWithTwoFactorStateTest extends OrchestraTestCase
{
    ...
    public function test_repeat_enable_request_does_not_disable_pending_confirmation()
    {
        ...
        $enableRequest->setUgaritSession($formRequest->session());
    ...
    private function createFormRequestWithUser(?UserWithTwoFactor $user = null): FormRequestInteractsWithTwoFactorState
    {
        ...
        $formRequest->setUgaritSession($this->app['session']->driver());
