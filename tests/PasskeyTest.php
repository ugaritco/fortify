...
class PasskeyTest extends OrchestraTestCase
{
    ...
    {
        $this->assertSame(\Ugarit\Passkeys\Passkey::class, \Ugarit\Passkeys\Passkeys::passkeyModel());
    }
    ...
    {
        $provider = $this->app->getProvider(\Ugarit\Fortify\FortifyServiceProvider::class);
